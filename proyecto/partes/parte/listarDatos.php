...
<body>
    ...
    <div class = "row">
    <div class="row">
					<h3 class="header left teal-text">LISTA DE PARTES DE MALA CONDUCTA</h3>
				</div>
              <table>
                <thead>
                  <tr>
  ...
  session_start();
                  ...
                  error_reporting(E_ALL);
                    ...
                    foreach($parteDao->listar() as $fila){
                      if ($fila['tipo'] == 'malaConducta') {
                        echo '  <tr>
                                  <td>' . $fila['id'] . '</td>
                                  <td>' . $fila['personaCitada'] . '</td>
                                  <td>' . $fila['profesor'] . '</td>
                                  <td>' . $fila['fecha_suceso'] . '</td>
                                  <td>  <a href="listarPartePorId.php?id=' . $fila['id'] . '" class="waves-effect waves-light btn  teal lighten-3"><i class="material-icons">remove_red_eye</i></a></td>
             ...
             <br>
             <a href="formulario.html" class="waves-effect waves-light  btn">INSERTAR NUEVO<i class="material-icons">library_add</i></a>
