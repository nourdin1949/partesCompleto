				...
				<form class="col s12" action="modificarDatos.php" method="POST">
					...
					<div class="row">
						...
						<br><br>
							...
							Muy señores nuestros: En consonancia con alumno/a, podrá anular dicha amonestación, quedando ésta invalidada a todos los efectos. <br> Por lo tanto, nos ponemos en contacto con ustedes para informarles de los motivos que han llevado a tramitar dicho "Parte de mala conducta" a su hijo/a:
